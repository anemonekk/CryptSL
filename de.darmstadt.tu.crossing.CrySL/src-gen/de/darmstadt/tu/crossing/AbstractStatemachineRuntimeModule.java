...
import de.darmstadt.tu.crossing.generator.StatemachineGenerator;
import de.darmstadt.tu.crossing.parser.antlr.StatemachineAntlrTokenFileProvider;
import de.darmstadt.tu.crossing.parser.antlr.StatemachineParser;
import de.darmstadt.tu.crossing.parser.antlr.internal.InternalStatemachineLexer;
import de.darmstadt.tu.crossing.scoping.StatemachineScopeProvider;
import de.darmstadt.tu.crossing.serializer.StatemachineSemanticSequencer;
import de.darmstadt.tu.crossing.serializer.StatemachineSyntacticSequencer;
import de.darmstadt.tu.crossing.services.StatemachineGrammarAccess;
import de.darmstadt.tu.crossing.validation.StatemachineValidator;
...
public abstract class AbstractStatemachineRuntimeModule extends DefaultCommonTypesRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/darmstadt/tu/crossing/Statemachine.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.darmstadt.tu.crossing.Statemachine");
	}
